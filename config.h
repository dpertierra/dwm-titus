...
static const char etagf[] = "[%s %s]";  /* format of an empty tag */
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Right,          focusstack,             {.i = +1 } }, // focus on the next client in the stack
	{ MODKEY,                       XK_Left,          focusstack,             {.i = -1 } }, // focus on the previous client in the stack
	...
	{ MODKEY|ShiftMask,             XK_Right,          setcfact,               {.f = -0.25} }, // decrease client size respective to other windows within the same area
	...
	{ MODKEY|ShiftMask,             XK_Left,       tagmon,                {.i = -1 } }, // tag previous monitor
	{ MODKEY|ShiftMask,             XK_Right,      tagmon,                {.i = +1 } }, // tag next monitor
	TAGKEYS(                        XK_1,                                  0)
	TAGKEYS(                        XK_2,                                  1)
	TAGKEYS(                        XK_3,                                  2)
	TAGKEYS(                        XK_4,                                  3)
